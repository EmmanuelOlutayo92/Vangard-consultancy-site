  ...
  <section class="hero" id="about">
    <div class="hero-content">
      ...
      <div class="hero-highlights">
        <div>
          <span class="metric">Tech-first</span>
          <span class="metric-label">Solution architecture</span>
        </div>
        <div>
          <span class="metric">Automation</span>
          <span class="metric-label">Operational efficiency</span>
        </div>
        <div>
          <span class="metric">Delivery</span>
          <span class="metric-label">Secure, scalable systems</span>
        </div>
      </div>
    </div>
    <div class="hero-panel">
      <div class="panel-card">
        ...
        <ul class="panel-list">
          ...
          <li>Product &amp; systems architecture</li>
      ...
      <div class="panel-card subtle">
        ...
        <div class="panel-client">
          ...
          <span class="client-role">Technology startup</span>
        </div>
      </div>
    </div>
  </section>
